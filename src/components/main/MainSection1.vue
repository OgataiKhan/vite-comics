<script>
import Product from './MainProduct.vue';
import LoadMore from './MainLoadMore.vue';
import FirstTitle from './MainFirstTitle.vue';
...
<template>
  <FirstTitle />
  <ul class="products">
    <Product v-for="product in products" :thumb="product.thumb" :series="product.series" />
  </ul>
  <LoadMore />
</template>
